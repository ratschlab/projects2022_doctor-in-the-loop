...
true_labels= np.array(circles_data.y)


probcover_learner= ProbCoverSampler(dataset=circles_data, purity_radius=None, purity_threshold=0.95, k=3, plot=[True, True],
