...
class ClusteringAlgo:
    ...
    def plot(self):
        ...
        sns.scatterplot(x=self.dataset.x[self.sampled_idx, 0], y=self.dataset.x[self.sampled_idx, 1], color="red",
                        marker="P", s=150)
...
class MySpectralClustering(ClusteringAlgo):
    def __init__(self, dataset, n_clusters, gamma, alpha=1, random_clustering=None, enforce_closeness=True,
                 enforce_separability=True):
